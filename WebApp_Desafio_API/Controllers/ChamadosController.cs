...
namespace WebApp_Desafio_API.Controllers
{
    ...
    public class ChamadosController : Controller
    {
        ...
        /// <summary>
        /// Obtém uma lista de solicitantes de acordo com o termo informado
        /// </summary>
        /// <param name="termo">O termo de pesquisa para os solicitantes</param>
        /// <returns></returns>
        [HttpGet]
        ...
        [ProducesResponseType(typeof(string), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        [Route("ObterSolicitantes")]
        public IActionResult ObterSolicitantes([FromQuery] string termo)
        {
            try
            {
                var solicitantes = this.bll.ObterSolicitantes(termo);
