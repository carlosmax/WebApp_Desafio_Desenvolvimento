...
namespace WebApp_Desafio_FrontEnd.Controllers
{
    public class ChamadosController : Controller
    {
        ...
        [HttpGet]
        public IActionResult ObterSolicitantes(string termo)
        {
            var chamadosApiClient = new ChamadosApiClient();
            var solicitantes = chamadosApiClient.ChamadosObterSolicitantes(termo);
        ...
        public IActionResult Cadastrar(ChamadoViewModel chamadoVM)
        {
            try
            {
                ...
                {
                    var mensagemErro = ModelState.Values
